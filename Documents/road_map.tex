...
To save data, either a single k-wall network, or an entire phase-scan and the related MS walls, use the option {\tt -w} in the command line. This will produce a file, whose name will be of the type:
\begin{center}
{\tt label\_YYYY-MM-DD-hh.mm.mose} 
\end{center}
with {\tt label} being either
\begin{center}
{\tt single\_network} or {\tt phase\_scan} .
\end{center}
