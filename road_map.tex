...
\section{Rotation of the phase}
A function that repeats the whole computation of primary k-walls, their intersections, generation of descendants, and iterations to get new intersections, new descendats etc.. for different phases.

It will have arguments such as: the number of daughter generations to be considered, the phase, the numerical options for growing kwalls, etc.

It's important that, at each phase, it \emph{stores the information about intersection points and their genealogy}. This information will then be used to construct full MS walls.
